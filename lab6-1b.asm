...
;Запуск выполняется программно по прерыванию АЦП
...
check_max:
	...
	mov A, @R0
	subb A, R1
	jnc end_of_handler; Если младший байт полученного значения оказался меньшим или равным младшему байту максимального
